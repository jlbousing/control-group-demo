...
@Component({
  selector: 'enterprise-assignaments',
  templateUrl: './enterprise-assignaments.component.html',
  styleUrls: ['./enterprise-assignaments.component.scss']
})
export class EnterpriseAssignamentsComponent implements OnInit {
